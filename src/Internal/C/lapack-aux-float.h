...
/* #define DVEC(A) int A##n, float*A##p */
#define QVEC(A) int A##n, complex*A##p
/* #define CVEC(A) int A##n, floatcomplex*A##p */
...
/* #define DMAT(A) int A##r, int A##c, float* A##p */
#define QMAT(A) int A##r, int A##c, complex* A##p
/* #define CMAT(A) int A##r, int A##c, floatcomplex* A##p */
...
/* #define KDVEC(A) int A##n, const float*A##p */
#define KQVEC(A) int A##n, const complex*A##p
/* #define KCVEC(A) int A##n, const floatcomplex*A##p */
...
/* #define KDMAT(A) int A##r, int A##c, const float* A##p */
#define KQMAT(A) int A##r, int A##c, const complex* A##p
/* #define KCMAT(A) int A##r, int A##c, const floatcomplex* A##p */
